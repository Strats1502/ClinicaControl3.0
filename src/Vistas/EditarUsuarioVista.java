 ...
 */
public class EditarUsuarioVista extends JPanel {
    //Componentes
    ...
    public EditarUsuarioVista(int idUsuario) {
    ...
    private void componentes() {
        ...
        btnImagenPerfil.addActionListener(new EditarUsuarioVista.CambiarImagen());
        btnGuardar.addActionListener(new EditarUsuarioVista.BotonGuardar());
        txtBuscar.addKeyListener(new EditarUsuarioVista.BuscarKeyAdapter());
        txtBuscar.addFocusListener(new EditarUsuarioVista.BuscarFocusAdapter());
        listaBuscador.addMouseListener(new EditarUsuarioVista.ListaBuscarMouseAdapter());
        btnEditar.addActionListener(new EditarUsuarioVista.BotonEditar());
        btnNuevo.addActionListener(new EditarUsuarioVista.BotonNuevo());
        comboBoxRol.addFocusListener(new EditarUsuarioVista.BotonRol());
        listaRol.addMouseListener(new EditarUsuarioVista.ListaRolMouseAdapter());
    ...
    private class BotonGuardar implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (datosCompletos(rol, nombre, apellidoPaterno, apellidoMaterno, correo, pass1, pass2)) {
                ...
                System.err.println(rol + nombre + apellidoPaterno + apellidoMaterno + correo + pass1 + pass2 + activo + administrador + pathFoto);
            }
    ...
    public static void main(String[] args) {
        ...
        f.add(new EditarUsuarioVista(2));
