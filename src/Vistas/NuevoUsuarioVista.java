 ...
 */
public class NuevoUsuarioVista extends JPanel {
    //Componentes
    ...
    public static BeautyScrollPane scrollBuscador = new BeautyScrollPane(listaBuscador , dlmBuscador, 300, 150, 300, 140);
    ...
    public NuevoUsuarioVista(int idUsuario) {
