 ...
 */
public class EditarPacienteVista extends JPanel {
    //Componentes
    ...
    public static BeautyErrorMessage pantallaOK = new BeautyErrorMessage("Paciente editado exitosamente");
    ...
    public EditarPacienteVista(int idUsuario) {
    ...
    private void componentes() {
        ...
        txtReligion = new BeautyTextField("Religion", 270, 370, 200, 20);
        ...
        btnImagenPerfil.addActionListener(new EditarPacienteVista.CambiarImagen());
        txtBuscar.addKeyListener(new EditarPacienteVista.BuscarKeyAdapter());
        txtBuscar.addFocusListener(new EditarPacienteVista.BuscarFocusAdapter());
        listaBuscador.addMouseListener(new EditarPacienteVista.ListaBuscarMouseAdapter());
        btnNuevo.addActionListener(new EditarPacienteVista.BotonNuevo());
        btnEditar.addActionListener(new EditarPacienteVista.BotonEditar());
        btnGuardar.addActionListener(new EditarPacienteVista.BotonGuardar());
    ...
    public static void main(String[] args) {
        ...
        f.add(new EditarPacienteVista(1));
