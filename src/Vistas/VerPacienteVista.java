 ...
 */
public class VerPacienteVista extends JPanel {
    //Componentes
    ...
    private void componentes() {
        ...
        //btnImagenPerfil.addActionListener(new VerPacienteVista.CambiarImagen());
        txtBuscar.addKeyListener(new VerPacienteVista.BuscarKeyAdapter());
        txtBuscar.addFocusListener(new VerPacienteVista.BuscarFocusAdapter());
        listaBuscador.addMouseListener(new ListaBuscarMouseAdapter());
        btnNuevo.addActionListener(new VerPacienteVista.BotonNuevo());
        btnEditar.addActionListener(new VerPacienteVista.BotonEditar());
        btnGuardar.addActionListener(new VerPacienteVista.BotonGuardar());
